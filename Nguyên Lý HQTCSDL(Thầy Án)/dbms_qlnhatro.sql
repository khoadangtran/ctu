...
insert into tai_khoan values (1, 'tdkhoa_2002', 'tdk@ctu', 'Trần Đăng Khoa', '0865074636', 'tdkhoa@gmail.com');
insert into tai_khoan values (2, 'ththanh_2002', 'ththanh@ctu', 'Trần Huy Thành', '0944353724', 'ththanh@gmail.com');
insert into tai_khoan values (3, 'httngoc_2002', 'httngoc@ctu', 'Huỳnh Trần Tuấn Ngọc', '0869241549', 'httngoc@gmail.com');
...
insert khach_tro values ('A','TRAN DANG KHOA','2002-08-15',095202008035,'nam',0789191224);
insert khach_tro values ('B','TRAN HUY THANH','2002-10-03',095202008035,'nam',0775630124);
insert khach_tro values ('C','HUYNH TRAN TUAN NGOC','2002-10-20',095202008035,'nam',0542367891);
insert khach_tro values ('D','NGUYEN VAN A','2001-07-08',095202008035,'nam',0787234524);
insert khach_tro values ('E','NGUYEN VAN B','2002-01-01',095202008035,'nam',0789245631);
insert khach_tro values ('F','NGUYEN VAN C','2002-11-22',095202008035,'nam',0786537894);
insert khach_tro values ('G','NGUYEN VAN D','2002-09-01',095202008035,'nam',0740563089);
insert khach_tro values ('H','NGUYEN VAN E','2001-12-25',095202008035,'nam',0789235456);
...
insert hdong_thue values (1,'A','001','2023-07-22','2026-07-22');
insert hdong_thue values (2,'B','002','2023-07-22','2026-07-22');
insert hdong_thue values (3,'C','002','2023-07-22','2026-07-22');
insert hdong_thue values (4,'D','003','2023-07-25','2026-07-25');
insert hdong_thue values (5,'E','004','2023-09-10','2026-09-10');
insert hdong_thue values (6,'F','004','2023-09-10','2026-09-10');
insert hdong_thue values (7,'G','005','2023-12-22','2026-12-22');
insert hdong_thue values (8,'H','005','2023-12-22','2026-12-22');
...
insert dich_vu values ('DN',9000,4000,'VND');
...
insert phieu_thu values (1,'001','2023-11-23',100000,100000,1000000,'N',1200000);
insert phieu_thu values (2,'002','2023-11-23',100000,100000,1000000,'N',1200000);
insert phieu_thu values (3,'003','2023-11-23',100000,100000,1000000,'Y',1200000);
...
call add_phieuthu('001','2023-10-17');
...
select doanh_thu_thang('2023-07');
...
-- test
call register('khoadt_2002', 'tdkhoa@ctu', 'tdkhoa@ctu', 'Trần Đăng Khoa', '0865074636', 'tdkhoa@gmail.com');
call register('khoianv_2002', 'vnakhoi@ctu', 'vnakhoi@cta', 'Vũ Nguyễn Anh Khôi', '0978779027', 'vnakhoi@gmail.com');
call register('toanpn_2002', 'nptoan@ctu', 'nptoan@ctu', 'Nguyễn Phú Toàn', '0839320863', 'nptoan@gmail.com');
...
call login ('abcxyz', 'mnbvcxz');
call login ('nhiyn', 'tadatada');
call login ('vikt', 'tkv@ctu');
...
select total_dien('2023-11-23');
select total_nuoc('2023-11-23');
...
drop function if exists firstName;
 select firstName('002','2','2023-10-07');
